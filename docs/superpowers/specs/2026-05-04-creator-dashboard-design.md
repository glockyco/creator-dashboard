...
| **End-to-end UI**         | Playwright | Dashboard loads behind Access, tile renders, manual refresh updates                         | Pre-deploy after an Access/JWKS-capable harness exists or against deployed Access |
