...
export const sourceRecords: SourceRecord[] = [
  ...
  { id: 'bing-ak-compendium', identity: 'WoW_Much', name: 'Bing: AK Compendium', category: 'analytics', cadenceHours: 24, connector: 'bingWebmaster', config: { siteUrl: 'https://ancient-kingdoms-compendium.wowmuch1.workers.dev/' } },
